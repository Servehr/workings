...
export const sendEmailToUser  =   async (data: any): Promise<any> =>
{
    let mailMessage =
        `<!DOCTYPE html>
                ...
                <tr>
                    ...
                    <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                        ...
                        <td style="padding-top:0px;padding-bottom:30px;padding-left:30px;padding-right:30px; background-color:#ffffff;">
                            <p style="margin:0;font-size: 30px;">Welcome to Technicians Platform</p>
                        </td>
                        </tr>
                        <tr>
                        <td style="padding-top:0px;padding-bottom:30px;padding-left:30px;padding-right:30px;font-size:24px;line-height:28px;font-weight:bold;background-color:#ffffff;border-bottom:1px solid #f0f0f5;border-color:rgba(201,201,207,.35);">
                            <a href="<a href="https://technicianswork.com" style="text-decoration:none;"><img src="https://technicianswork.com/Welcome-Registration.png" width="540" alt="" style="width:100%;height:auto;border:none;text-decoration:none;color:#363636;"></a>
                        </td>
                        </tr> 
                        ...
                        <td style="padding-top:0px;padding-bottom:30px;padding-left:30px;padding-right:30px;background-color:#ffffff;text-align:center;">
                            <p style="margin:0;">Some wordings here.</p>
                        </td>
                        </tr>
                        <tr>
    ...
    var mailOptions = 
    {
       from: EMAIL_USER,
       to: data.email,
       subject: 'We Welcome You To Technicians Work Platform',
